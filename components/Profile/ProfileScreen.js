    ...
    <View style={styles.container}>
      ...
      >
          <View style={styles.centeredView}>
              <View style={styles.modalView}>
                  <View style={{justifyContent: 'center', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#CCC'}}> 
                      <Text style={{fontSize: 16, fontWeight:'600', padding: 8}}>Sửa Thông Tin Khách Hàng</Text>
                  </View>
                  <View style={{marginVertical: 20, flexDirection: 'row'}}>
                      <View style={{flex: 1}}>
                        <View style={{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center'}}>
                          ...
                          <TextInput
                                style={{flex: 1, textAlignVertical: "top", marginTop: 8,paddingTop: 8, borderWidth: 1, borderColor: '#ccc', borderRadius: 20, paddingHorizontal: 12}}
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center', marginTop: 20}}>
                          <Text style={{ width: '30%', paddingTop: 16}}>Số điện thoại: </Text>
                          <TextInput
                                style={{flex: 1, textAlignVertical: "top", marginTop: 8,paddingTop: 8, borderWidth: 1, borderColor: '#ccc', borderRadius: 20, paddingHorizontal: 12}}
                  ...
                  <View style={{flex: 1, justifyContent: 'flex-end'}}>
                      <View style={{ bottom: 0, flexDirection: 'row-reverse', alignContent: 'flex-end'}}>
                          ...
                          <TouchableOpacity
                          style={[styles.button, styles.buttonExist, { marginRight: 12, width: 80}]}
                          onPress={() => cancelName()}>
    ...
    
        {
          ...
          <Text style={[styles.headerText, { alignSelf: "center", marginTop: 20 }]}>
            TÀI KHOẢN
          </Text>
            ...
            <View style={styles.accountInfo}>
              <View>
                ...
                <View style={{ padding: 10 }}>
                  ...
                  <Text style={styles.text}>Số điện thoại: {phone != '' ? phone : 'Chưa thiết lập'}</Text>
                  <View style={{flexDirection: 'row', marginTop: 20}}>
                    <TouchableOpacity style={[styles.changePass, { backgroundColor: 'green', padding: 8, borderRadius: 12, width: '45%'}]}
                      onPress={() => navigation.navigate("ChangePassword")}
                    >
                      <Text style={[styles.changePassText, {color: '#fff',textAlign: 'center'}]}>Đổi mật khẩu</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.changePass, { backgroundColor: 'green', padding: 8, borderRadius: 12, marginLeft: 20, width: '45%'}]}
                      onPress={() => setModalNameVisible(true)}>
                      <Text style={[styles.changePassText, {color: '#fff', textAlign: 'center'}]}>Đổi thông tin</Text>
                    </TouchableOpacity>
                  </View>
    
                  {
                    ...
                    <View style={{flexDirection: 'row', marginTop: 20}}>
                    <TouchableOpacity style={[styles.changePass, { backgroundColor: 'green', padding: 8, borderRadius: 12, width: '45%'}]}
                      onPress={() => navigation.navigate("OrderManagerScreen")}
                    >
                      <Text style={[styles.changePassText, {color: '#fff',textAlign: 'center'}]}>Quản lý đơn hàng</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.changePass, { backgroundColor: 'green', padding: 8, borderRadius: 12, marginLeft: 20, width: '45%'}]}
                      onPress={() => navigation.navigate("UserManagerScreen")}>
                      <Text style={[styles.changePassText, {color: '#fff',textAlign: 'center'}]}>Quản lý người dùng</Text>
                    </TouchableOpacity>
                  </View>)
                  : <View></View>
                  }
          ...
          <TouchableOpacity onPress={() =>   Alert.alert("Thông báo", "Bạn có chắc chắn muốn xóa tài khoản này ?",
      [
        {
          text: "Cancel",
